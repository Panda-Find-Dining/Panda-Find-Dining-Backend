...
urlpatterns = [
     ...
     path('api/googleapicall/<int:pk>/',views.GoogleAPICall.as_view(), name='google api call'),
     ...
     path('api/tokenpk/',views.TokenObtainView.as_view(), name='new-token,obtain-view')
]
